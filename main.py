...
def main(page: flet.Page):
    ...
    def encode_choice(e):
        ...
        main_container.content = flet.Column(
            [flet.Container(flet.Row([text_to_encode], alignment=flet.MainAxisAlignment.CENTER)),
    ...
    text_to_encode = flet.Container(border=flet.border.all(2, "black"), bgcolor="#28282b", border_radius=10, width=300,
                                    padding=flet.padding.only(right=3),
    ...
    # Tlačítko "zpět na výběr code/decode"
